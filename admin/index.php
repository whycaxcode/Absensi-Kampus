	...
	<div class="container">
		...
		<div class="row log">
		    <div class="col s7 offset-s2 card-panel z-depth-3">
		      ...
		      <form method="post" action="">
		        <div class="row">
		          ...
		          <div class="input-field col s12">
		            <button class="btn xxy col s12 blue darken-1" name="login"><i class="mdi mdi-forward left"></i>Masuk</button>
		          </div>
		    ...
		    <div class="col s7 offset-s2 card-panel z-depth-3"><br>
		    		...
		    		<a class="waves-effect waves-light btn blue darken-1 col s12" href="../dosen.php" style="margin-bottom:20px;"><i class="mdi mdi-forward left"></i>Login Dosen</a>
